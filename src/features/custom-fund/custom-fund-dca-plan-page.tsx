  ...
  return (
    <div>
      ...
      <WorkbenchLayout
        align="start"
        pool={
          <WorkbenchPanel title={t(language, "portfolio.planSnapshot")} subtitle={t(language, "custom.dcaPlanSnapshotSubtitle")} className="flex min-h-[38rem] flex-col xl:h-[40rem]">
